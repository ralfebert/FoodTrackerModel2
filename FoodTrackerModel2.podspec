#
# Be sure to run `pod lib lint FoodTrackerModel2.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'FoodTrackerModel2'
  s.version          = '0.1.0'
  s.summary          = 'A short description of FoodTrackerModel2.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'FoodTrackerModel2' => ['FoodTrackerModel2/Assets/*.png']
  # }
